...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-danger radius" onclick="datadel()" href="javascript:;"><i class="Hui-iconfont"></i> 批量删除</a> <a  href="<?php echo url('Product/product_add'); ?>" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加产品</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg">
				<thead>
					...
					<tr class="text-c">
						...
						<th width="40">ID</th>
						<th width="200">产品昵称</th>
						<th>分类ID</th>
						<th width="300">产品期限</th>
						<th>开始时间</th>
						<th>结束时间</th>
						<th>最低可投</th>
						<th>介绍</th>
