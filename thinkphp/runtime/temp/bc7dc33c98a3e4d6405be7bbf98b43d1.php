...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont"></i> 首页 <span class="c-gray en">&gt;</span> RBAC管理 <span class="c-gray en">&gt;</span> 权限管理 <a title="刷新" href="javascript:location.replace(location.href);" style="line-height:1.6em;margin-top:3px" class="btn btn-success radius r"><i class="Hui-iconfont"></i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius"  href="<?php echo url('Jurisdiction/jsdt_add'); ?>"><i class="Hui-iconfont"></i> 添加权限</a></span></div>
				...
				<?php foreach($data as $key=>$val):?>
						<tr class="text-c">
							...
							<?php if(\think\Session::get('name')=='KevinJia'){?>
										<a style="text-decoration:none" class="ml-5" href="<?php echo url('Jurisdiction/jsdt_update'); ?>?noteId=<?= $val['noteId']?>" title="编辑">
											<i class="Hui-iconfont"></i>
										</a> 
										<a style="text-decoration:none" href="<?php echo url('Jurisdiction/jsdt_del'); ?>?noteId=<?= $val['noteId']?>" title="删除">
											<i class="Hui-iconfont"></i>
										</a>
									<?php }else{?>
									不可操作
