...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-danger radius" onclick="datadel()" href="javascript:;"><i class="Hui-iconfont"></i> 批量删除</a> <a  href="<?php echo url('Jurisdiction/role_add'); ?>" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加数据</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-hover table-bg">
				<thead>
					<tr>
						<th colspan="6" scope="col">采集管理</th>
					</tr>
					<tr class="text-c">
				...
				<tbody>
					<tr class="text-c">
						...
						<td>1</td>
						<td class="f-14"><a style="text-decoration:none" onclick="admin_role_edit('角色编辑','role_add.html','1')" href="javascript:;" title="编辑"><i class="Hui-iconfont"></i></a> <a style="text-decoration:none" class="ml-5" onclick="admin_role_del(this,'1')" href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a></td>
					</tr>
				</tbody>
			</table>
			</div>
